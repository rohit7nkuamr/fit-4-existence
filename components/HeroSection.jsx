...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="pt-24 pb-12 md:pt-32 md:pb-24 overflow-hidden">
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            <h1 className="heading-1 text-primary-900 mb-4 md:mb-6 text-center lg:text-left">
              Your Journey To <span className="text-primary-600">Better Health</span> Starts Here
            </h1>
          ...
          >
            ...
            <div className={`absolute ${isMobile ? '-bottom-4 left-4' : '-bottom-6 -left-6'} bg-white p-3 md:p-4 rounded-lg shadow-xl max-w-[160px] md:max-w-none`}>
            ...
            <div className={`absolute ${isMobile ? '-top-4 right-4' : '-top-6 -right-6'} bg-white p-3 md:p-4 rounded-lg shadow-xl max-w-[160px] md:max-w-none`}>
              <div className="flex items-center space-x-3 md:space-x-4">
                <div className="bg-secondary-100 p-2 md:p-3 rounded-full">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 md:h-6 md:w-6 text-secondary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
