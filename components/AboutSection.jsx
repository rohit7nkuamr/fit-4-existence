...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="section-padding bg-gradient-to-b from-[#f5efe6] to-[#f8f5f1]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            <div className="relative h-[300px] sm:h-[350px] md:h-[400px] lg:h-[500px] w-full rounded-xl md:rounded-2xl overflow-hidden">
              <Image
                src="/images/about/clinic-interior.jpg" /* Place your about image at this path */
                alt="Dr. Prince Raj with patient"
                fill
            ...
            <div className="absolute bottom-4 right-4 md:-bottom-8 md:-right-8 bg-[#faf7f2] p-4 md:p-6 rounded-lg md:rounded-xl shadow-lg md:shadow-xl max-w-[200px] md:max-w-xs border border-[#e5d8c3]">
              <div className="flex items-center space-x-3 md:space-x-4 mb-2 md:mb-4">
                ...
                <h3 className="font-display font-bold text-base md:text-lg text-gray-900">Our Experience</h3>
              </div>
              <p className="text-gray-600 text-sm md:text-base">
                With over 3+ years of experience, we've helped Hundreds of patients recover from pain.
              </p>
            </div>
          </motion.div>
